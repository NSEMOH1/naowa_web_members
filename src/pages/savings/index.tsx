  ...
  return (
    <div>
      ...
      <div className="flex w-full gap-4 mt-4">
        <div className="w-full">
          <div className="flex-1">
            <div className="p-4 bg-[#982323] shadow-lg text-white rounded-2xl h-[150px]">
      ...
      <div className="mt-4">
        ...
        <div className="p-4 bg-gradient-to-b from-[#d13838] via-[#c32d2d] to-[#982323] text-white rounded-2xl mt-4 shadow-lg">

      ...
      <div className="flex w-full gap-4 mt-4">
        <div className="w-full">
          <div className="flex-1">
            <div className="p-4 bg-[#982323] text-white rounded-2xl h-[150px] shadow-lg">
              <p className="pb-3">Total Saving Balance</p>
              <div>
                <p className="text-2xl font-bold">
                  ₦{balance?.cooperativeSavings?.toString() ?? "0"}
                </p>
              </div>
            </div>
            <div>
              <div className="mt-6">
                ...
                <div className="flex gap-4 mt-2 flex-col md:flex-row">
                  <div
                    ...
                    className="p-4 py-6 text-white w-full rounded-lg shadow-lg"
                  >

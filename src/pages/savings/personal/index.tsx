  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center">
        <div>
          <div className="p-4 bg-[#982323] text-white rounded-2xl h-[150px] w-[100vw] md:w-[50vw]">
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <div className="flex gap-4">
                <Button
                  onClick={() => navigate(routes.withdrawal.index)}
                  size="sm"
                  bg="aliceblue"
                  border="1px solid black"
                  leftIcon={<Download size={14} color="black" />}
                >
                  Withdraw
                </Button>
              </div>

...
const Settings = () => {
  ...
  const [profileForm, setProfileForm] = useState({
    ...
    bankName: member?.bank[0].bank_name || "",
  ...
  const handleNextOfKinUpdate = async () => {
    ...
    try {
      ...
      await api.put(`/api/member/${user?.id}`, {
        next_of_kin: {
          ...
          <>
            ...
            <ModalBody>
              <div className="grid grid-cols-2 gap-4">
                <FormControl
                  isRequired
                  isInvalid={!profileForm.fullName?.trim()}
                >
            ...
            <ModalFooter>
              ...
              <Button
                ...
                isDisabled={
                  !profileForm.fullName?.trim() || !profileForm.email?.trim()
                }
              >
                Save Changes
              </Button>
    ...
    <div>
      ...
      <div>
        <div className="flex gap-2 items-center">
          <Avatar src={member?.full_name} size="lg" />
          <div>
